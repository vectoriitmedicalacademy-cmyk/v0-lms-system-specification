    ...
    <div className="flex min-h-screen" style={{ background: "hsl(var(--outer-bg))" }}>
      <div className="flex w-full flex-col items-center justify-center p-4">
        ...
        <motion.div
          ...
          className="w-full max-w-5xl overflow-hidden rounded-2xl bg-card shadow-2xl"
        >
            ...
            <div className="flex flex-1 flex-col gap-6 text-center lg:text-left">
              ...
              >
                <motion.div
                  ...
                  className="flex h-12 w-12 items-center justify-center rounded-lg bg-foreground"
                >
              ...
              <div className="space-y-5">
                ...
                <div className="grid grid-cols-2 gap-2">
                  {roles.map(({ role, label, icon }, i) => (
                    <motion.button
                      ...
                      className={`relative flex items-center gap-2.5 rounded-xl border p-3.5 text-left transition-colors ${
                        selectedRole === role
                ...
                <Tabs value={authMethod} onValueChange={(v) => setAuthMethod(v as "otp" | "password")}>
                  ...
                  <AnimatePresence mode="wait">
                    ...
                    >
                      <TabsContent value="password" className="space-y-4 pt-3" forceMount={authMethod === "password" ? true : undefined}>
                        {authMethod === "password" && (
                          <>
                      ...
                      <TabsContent value="otp" className="space-y-4 pt-3" forceMount={authMethod === "otp" ? true : undefined}>
                        {authMethod === "otp" && (
                          <>
                            <div className="space-y-2">
