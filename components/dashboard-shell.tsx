...
import {
  ...
  HelpCircle, Search, MessageCircle, Swords
} from "lucide-react"
...
const navConfig: Record<Role, NavItem[]> = {
  student: [
    ...
    { label: "Video Lectures", icon: <Eye className="h-5 w-5" />, id: "videos" },
...
export function DashboardShell({ children }: DashboardShellProps) {
  ...
  return (
    <div className="flex h-screen" style={{ background: "hsl(var(--outer-bg))" }}>
      {/* Full page wrapper with dark outer */}
      <div className="flex h-full w-full flex-col">
        ...
        {/* White inner card */}
        <div className="mx-3 mb-3 flex flex-1 overflow-hidden rounded-2xl bg-card shadow-2xl">
          {/* Left sidebar */}
              ...
              <div className="flex items-center gap-1">
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <button className="ml-1 flex h-10 w-10 items-center justify-center rounded-full border-2 border-border overflow-hidden hover:border-primary transition-colors">
